...
{net_council_tax_due}|
12 PAYMENTS WILL BE DEBITED DIRECTLY FROM YOUR BANK ACCOUNT AS FOLLOWS:|
{month_1}|£{first_instalment}|{month_7}|£{next_instalment}|
{month_2}|£{next_instalment}|{month_8}|£{next_instalment}|
{month_3}|£{next_instalment}|{month_8}|£{next_instalment}|
{month_4}|£{next_instalment}|{month_10}|£{next_instalment}|
{month_5}|£{next_instalment}|{month_11}|£{next_instalment}|
{month_6}|£{next_instalment}|{month_12}|£{next_instalment}|
"""
)
